...
def main(args):
    ...
    exp_path = Path(args.output_dir) / (args.id + '-' + args.ood) / '-'.join([args.arch, args.training, 'b_'+str(args.beta), args.scheduler, 'greedy_'+str(args.ood_quantile)])
    ...
    test_all_set_ood = get_ds(root=args.data_dir, ds_name=args.ood, splot='wo_cifar', transform=test_trf_ood)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--training', type=str, default='abs', choices=['uni', 'abs', 'energy', 'binary'])
