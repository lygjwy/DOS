...
class wide_basic(nn.Module):
    def __init__(self, in_planes, planes, dropout_rate, stride=1):
        ...
        # self.bn1 = nn.InstanceNorm2d(in_planes, affine=True) # instance normalization
...
class Wide_ResNet(nn.Module):
    def __init__(self, depth, widen_factor, dropout_rate, num_classes, in_size=32, include_binary=True):
        ...
        # self.bn1 = nn.InstanceNorm2d(nStages[3], affine=True)
        ...
        if self.include_binary:
            self.binary_linear = nn.Linear(1, 1, bias=False) # energy as variable
            nn.init.kaiming_normal_(self.binary_linear.weight.data, nonlinearity='relu')
            # self.binary_linear.bias.data = torch.zeros(size=self.binary_linear.bias.size())
