...
# Without OE
python detect.py --id cifar10 --pretrain ./ckpts/cifar10/wrn40/cla_best.pth --gpu_idx 0

# With OE
## random sample
python detect.py --id cifar10 --pretrain ./ckpts/cifar10-tiny_images/wrn40-random/cla_last.pth --gpu_idx 0
