...
for w in conf dens; do
    python detect.py --id cifar10 --pretrain ./outputs/cifar10-tiny_images/wrn40-${w}-wc/cla_last.pth --gpu_idx 0
    python detect.py --id cifar10 --pretrain ./outputs/cifar10-tiny_images/wrn40-${w}-woc/cla_last.pth --gpu_idx 0
done